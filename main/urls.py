...
urlpatterns = [
    ...
    path("api/v1/khalti/verify/", verify_khalti_payment, name="verify_khalti_payment"),
    ...
    path("api/v1/notifications/<int:pk>/delete/", DeleteNotificationView.as_view(), name="delete-notification"),
