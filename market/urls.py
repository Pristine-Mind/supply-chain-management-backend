...
urlpatterns = [
    ...
    path("api/register/business/", BusinessRegisterView.as_view(), name="business-register"),
    ...
    path("api/products/<int:product_id>/related/", RelatedProductsView.as_view(), name="related-products"),
    path("api/products/<int:product_id>/more-from-seller/", MoreFromSellerView.as_view(), name="more-from-seller"),
