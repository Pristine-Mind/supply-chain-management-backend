...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='market.marketplaceorder', verbose_name='Order'),
        ),
        migrations.AddField(
            model_name='marketplaceorderitem',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order_items', to='producer.marketplaceproduct', verbose_name='Product'),
        ),
        migrations.AddField(
            model_name='marketplaceorder',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='marketplace_orders', to=settings.AUTH_USER_MODEL, verbose_name='Customer'),
        ),
        migrations.AddField(
            model_name='marketplaceorder',
            name='delivery',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='orders', to='market.deliveryinfo', verbose_name='Delivery Information'),
        ),
        migrations.AddIndex(
