...
class CategoryAPITestCase(TestCase):
    def setUp(self):
        ...
        # Create test data
        self.category = Category.objects.create(code="TEST", name="Test Category")
        self.subcategory = Subcategory.objects.create(code="TEST_SUB", name="Test Subcategory", category=self.category)
        self.sub_subcategory = SubSubcategory.objects.create(
            code="TEST_SUB_SUB", name="Test Sub-Subcategory", subcategory=self.subcategory
        )
    ...
    def test_product_category_hierarchy(self):
        ...
        producer = Producer.objects.create(
            name="Test Producer", contact="123456789", address="Test Address", registration_number="TEST123", user=self.user
        )
