...
def populate_categories(apps, schema_editor):
    ...
    categories_data = [
        {
            "code": "FA", "name": "Fashion & Apparel",
            "subcategories": [
                {"code": "FA_CL", "name": "Clothing", "sub_subcategories": [
                    {"code": "FA_CL_MW", "name": "Men's Wear"},
                    {"code": "FA_CL_WW", "name": "Women's Wear"},
                    {"code": "FA_CL_KW", "name": "Kids' Wear"},
                ]},
                {"code": "FA_FW", "name": "Footwear", "sub_subcategories": [
        ...
        {
            "code": "EG", "name": "Electronics & Gadgets",
            "subcategories": [
                {"code": "EG_MB", "name": "Mobile & Computing", "sub_subcategories": [
        ...
        {
            "code": "GE", "name": "Groceries & Essentials",
            "subcategories": [
                {"code": "GE_FD", "name": "Food & Beverages", "sub_subcategories": [
                    {"code": "GE_FD_FR", "name": "Fresh Produce"},
                ]},
            ]
        },
        {
            "code": "HB", "name": "Health & Beauty",
            "subcategories": [
                {"code": "HB_SK", "name": "Skincare", "sub_subcategories": [
                    {"code": "HB_SK_FC", "name": "Face Care"},
                ]},
            ]
        },
        {
            "code": "HL", "name": "Home & Living",
            "subcategories": [
                {"code": "HL_FR", "name": "Furniture", "sub_subcategories": [
        ...
        },
        {
            ...
            "subcategories": [
                {"code": "TT_LG", "name": "Luggage & Bags", "sub_subcategories": [
                    {"code": "TT_LG_SC", "name": "Suitcases"},
                ]},
            ]
        },
        {
            "code": "IS", "name": "Industrial Supplies",
            "subcategories": [
                {"code": "IS_TL", "name": "Tools & Equipment", "sub_subcategories": [
        ...
        },
        {
            "code": "OT", "name": "Other",
            "subcategories": [
                {"code": "OT_SP", "name": "Specialty Items", "sub_subcategories": [
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='producer.category', verbose_name='Category'),
        ),
        migrations.AddField(
            model_name='product',
            name='subcategory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='producer.subcategory', verbose_name='Subcategory'),
        ),
        migrations.AddField(
            model_name='product',
            name='sub_subcategory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='producer.subsubcategory', verbose_name='Sub-subcategory'),
        ),
