...
def create_brand_feature_string(brand_data: dict) -> str:
    ...
    if origin: feature += f" Origin: {origin}."
    if description: feature += f" Details: {description}."
    return feature
...
if __name__ == "__main__":
    ...
    sample_prod = {"name": "HOME PUJA SAMAGRI", "category_details": "Garden & Outdoor", "brand_name": "Unbranded", "description": "<p>Complete essential kit for daily worship.</p>"}
