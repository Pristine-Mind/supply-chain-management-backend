...
import torch
from models.graph_models import EdgeType, GraphEdge, GraphNode, NodeType
...
def build_hetero_graph():
    ...
    for profile in profiles:
        ...
        valid_node = GraphNode(
            node_id=node_id, node_type=NodeType.STORE, raw_text_feature=s_v, business_role=profile["business_type"]
        )
