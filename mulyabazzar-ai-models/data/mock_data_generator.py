...
class MockGraphDataGenerator:
    ...
    def generate(self):
        ...
        print(f"Users: {self.num_users} | Products per user: {self.products_per_user} | B2B Edges: {self.num_interactions} | Sales: {self.num_sales}")
...
if __name__ == "__main__":
    ...
    generator = MockGraphDataGenerator(
        ...
        products_per_user=args.products,
